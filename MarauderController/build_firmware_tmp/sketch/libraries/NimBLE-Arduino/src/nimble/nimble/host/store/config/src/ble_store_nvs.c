#line 1 "/root/E32K/MarauderController/app/src/main/assets/esp32_marauder/libraries/NimBLE-Arduino/src/nimble/nimble/host/store/config/src/ble_store_nvs.c"
/*
