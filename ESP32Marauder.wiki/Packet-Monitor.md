...
## For non-touch screen hardware
The packet monitor will be a feed of frames picked up by the ESP32 Marauder. The displayed text will be color coded to indicate what type of frame it is.

| Color   | Frame Type       |
| ------- | ---------------- |
| Green   | Beacon           |
| Cyan    | Probe Request    |
| Magenta | Misc. Management |
| Red     | Deauthentication |
| White   | Data             |